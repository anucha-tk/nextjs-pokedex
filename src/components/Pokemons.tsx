...
function Pokemons() {
	...
	return (
		<section id="pokemons" className="mx-8 mb-6 grid space-y-4">
			<div className="grid gap-4 lg:grid-cols-3">
				{pokemons?.map((pokemon) => {
					...
					return (
						<div
							key={pokemon.id}
							className="h-fit w-full rounded-lg border bg-gray-100 p-4 shadow-md hover:bg-gray-200"
						>
							<h5 className="font-bold text-2xl text-gray-900 uppercase tracking-tight">
								{pokemon.name}
							</h5>
